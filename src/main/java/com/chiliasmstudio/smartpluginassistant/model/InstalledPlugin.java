...
public class InstalledPlugin {
    ...
    private String projectId; // Modrinth project id/slug if known
    private String versionId; // Modrinth version id if known
    private String pluginName; // Human readable name
    private String currentVersionNumber; // e.g. 1.12.0
    private String sha1;
