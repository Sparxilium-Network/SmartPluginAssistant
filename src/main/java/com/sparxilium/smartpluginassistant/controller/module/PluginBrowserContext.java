...
public class PluginBrowserContext {
    ...
    public PluginBrowserContext(ServerInstance currentInstance, ModrinthService modrinthService, HangarService hangarService, VoxelService voxelService, InstanceManager instanceManager, Runnable onPluginInstalledCallback, Stage parentStage) {
